...
//    //   solo usando extern const en vez de constexpr ya que estas no admiten
//    declaraciones anticipadas

//    //  como las variables reales estan desntro de un namespace,
//    //  las decalraciones anticipoadas tambein deben de estar dentro de un
//    namespace

//    extern const double pi;
//    extern const double e;
//    extern const double gravedad; // m/s^2,  la gravedad esligera en este
//    planeta
...
inline constexpr double gravedad{
    9.2}; // m/s^2,  la gravedad esligera en este planeta
} // namespace constantes
#endif
